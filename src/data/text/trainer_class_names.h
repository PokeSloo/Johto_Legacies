const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _("TEAM PHOENIX"),
    ...
    [TRAINER_CLASS_WINSTRATE] = _("NURSE"),
    ...
    [TRAINER_CLASS_SALON_MAIDEN] = _("COWGIRL"),
    [TRAINER_CLASS_DOME_ACE] = _("TOURIST"),
    [TRAINER_CLASS_PALACE_MAVEN] = _("SNOWBOARDER"),
    [TRAINER_CLASS_ARENA_TYCOON] = _("SKIIER"),
    [TRAINER_CLASS_FACTORY_HEAD] = _("SAGE"),
    [TRAINER_CLASS_PIKE_QUEEN] = _("KIMONO GIRL"),
    [TRAINER_CLASS_PYRAMID_KING] = _("TOWER CHAMP"),
