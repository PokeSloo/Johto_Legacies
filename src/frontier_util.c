...
const u16 gFrontierBannedSpecies[] =
{
    ...
    SPECIES_DIALGA, SPECIES_PALKIA, SPECIES_GIRATINA, SPECIES_ARCEUS, SPECIES_URSHIFU,
    SPECIES_HEATRAN, SPECIES_REGIGIGAS, SPECIES_CRESSELIA, SPECIES_PHIONE, SPECIES_MANAPHY,
    SPECIES_DARKRAI, SPECIES_SHAYMIN, SPECIES_VICTINI, SPECIES_RESHIRAM, SPECIES_ZEKROM,
    SPECIES_KYUREM, SPECIES_MELOETTA, SPECIES_GENESECT, SPECIES_XERNEAS, SPECIES_YVELTAL,
    SPECIES_ZYGARDE, SPECIES_DIANCIE, SPECIES_HOOPA, SPECIES_VOLCANION, SPECIES_SOLGALEO,
    SPECIES_LUNALA, SPECIES_NIHILEGO, SPECIES_BUZZWOLE, SPECIES_PHEROMOSA, SPECIES_XURKITREE,
    SPECIES_CELESTEELA, SPECIES_KARTANA, SPECIES_GUZZLORD, SPECIES_NECROZMA, SPECIES_MAGEARNA,
    SPECIES_MARSHADOW, SPECIES_POIPOLE, SPECIES_NAGANADEL, SPECIES_STAKATAKA, SPECIES_BLACEPHALON,
    SPECIES_ZERAORA, SPECIES_MELMETAL, SPECIES_ZACIAN, SPECIES_ZAMAZENTA, SPECIES_ETERNATUS,
    SPECIES_ZARUDE, SPECIES_GLASTRIER, SPECIES_SPECTRIER, SPECIES_CALYREX, 0xFFFF
};
