...
const u8 gText_EggFromHotSprings[] = _("A mysterious POKéMON EGG,\nwhat could be inside?");
...
const u8 gText_TreeckoDollAndPrice[] = _("Pikachu      1,000 COINS");
const u8 gText_TorchicDollAndPrice[] = _("Applin         5,000 COINS");
const u8 gText_MudkipDollAndPrice[] = _("Porygon      9,999 COINS");
...
const u8 gText_TM32AndPrice[] = _("Focus Sash{CLEAR_TO 0x48}1,500 COINS");
const u8 gText_TM29AndPrice[] = _("King's Rock{CLEAR_TO 0x48}3,500 COINS");
const u8 gText_TM35AndPrice[] = _("Bright Powder{CLEAR_TO 0x48}4,000 COINS");
const u8 gText_TM24AndPrice[] = _("Lucky Egg{CLEAR_TO 0x48}4,000 COINS");
const u8 gText_TM13AndPrice[] = _("Choice Scarf{CLEAR_TO 0x48}4,000 COINS");
...
const u8 gText_Protein1BP[] = _("Nugget{CLEAR_TO 0x64}1BP");
const u8 gText_Calcium1BP[] = _("Big Nugget{CLEAR_TO 0x64}4BP");
const u8 gText_Iron1BP[] = _("PP Up{CLEAR_TO 0x64}1BP");
const u8 gText_Zinc1BP[] = _("PP Max{CLEAR_TO 0x64}5BP");
const u8 gText_Carbos1BP[] = _("Rare Candy{CLEAR_TO 0x64}1BP");
const u8 gText_HpUp1BP[] = _("Master Ball{CLEAR_TO 0x64}10BP");
const u8 gText_Leftovers48BP[] = _("Leftovers{CLEAR_TO 0x5E}48BP");
const u8 gText_WhiteHerb48BP[] = _("Choice Specs{CLEAR_TO 0x5E}64BP");
const u8 gText_QuickClaw48BP[] = _("Quick Claw{CLEAR_TO 0x5E}48BP");
const u8 gText_MentalHerb48BP[] = _("Choice Scarf{CLEAR_TO 0x5E}64BP");
const u8 gText_BrightPowder64BP[] = _("Bright Powder{CLEAR_TO 0x5E}48BP");
...
const u8 gText_MrStoneMatchCallDesc[] = _("JERK FACE");
const u8 gText_MrStoneMatchCallName[] = _("SHANE");
const u8 gText_StevenMatchCallDesc[] = _("DEPENDABLE");
const u8 gText_StevenMatchCallName[] = _("DAD");
const u8 gText_MayBrendanMatchCallDesc[] = _("RAD NEIGHBOR");
const u8 gText_NormanMatchCallDesc[] = _("ROCKSTAR");
const u8 gText_MomMatchCallDesc[] = _("CALM & KIND");
const u8 gText_WallyMatchCallDesc[] = _("AIRHEAD");
const u8 gText_NormanMatchCallName[] = _("CHARLIE");
const u8 gText_MomMatchCallName[] = _("MOM");
const u8 gText_ScottMatchCallDesc[] = _("AIRHEAD");
const u8 gText_ScottMatchCallName[] = _("OLIVER");
const u8 gText_RoxanneMatchCallDesc[] = _("SKY HIGH");
const u8 gText_BrawlyMatchCallDesc[] = _("PRINCESS");
const u8 gText_WattsonMatchCallDesc[] = _("TV STAR");
const u8 gText_FlanneryMatchCallDesc[] = _("CALM CONFIDENT");
const u8 gText_WinonaMatchCallDesc[] = _("LIKE WATER");
const u8 gText_TateLizaMatchCallDesc[] = _("VERY COOL");
const u8 gText_JuanMatchCallDesc[] = _("POWERFUL");
