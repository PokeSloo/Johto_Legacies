...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_KAREN] = REMATCH(TRAINER_KAREN_1, TRAINER_KAREN_2, TRAINER_KAREN_3, TRAINER_KAREN_4, TRAINER_KAREN_5, GRANITE_CAVE_B1F),
    [REMATCH_JERRY] = REMATCH(TRAINER_JERRY_1, TRAINER_JERRY_2, TRAINER_JERRY_3, TRAINER_JERRY_4, TRAINER_JERRY_5, GRANITE_CAVE_1F),
    ...
    [REMATCH_ISABEL] = REMATCH(TRAINER_ISABEL_1, TRAINER_ISABEL_2, TRAINER_ISABEL_3, TRAINER_ISABEL_4, TRAINER_ISABEL_5, SHOAL_CAVE_LOW_TIDE_ENTRANCE_ROOM),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_SAWYER_1, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, ARTISAN_CAVE_B1F),
...
static u8 GetSumOfEnemyPartyLevel(u16 opponentId, u8 numMons)
{
    ...
    case F_TRAINER_PARTY_DYNAMIC_LEVEL:
        {
            const struct TrainerMonDynamicLevel *party;
            party = gTrainers[opponentId].party.NoItemDynamicLevel;
            for (i = 0; i < count; i++)
                sum += level;
        }
        break;
