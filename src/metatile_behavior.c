...
static const u8 sTileBitAttributes[NUM_METATILE_BEHAVIORS] =
{
    ...
    [MB_HOT_SPRINGS]                     = TILE_FLAG_UNUSED | TILE_FLAG_HAS_ENCOUNTERS,
...
bool8 MetatileBehavior_IsSnowPath(u8 metatileBehavior)
{
    if (metatileBehavior == MB_SNOW_PATH)
        return TRUE;
    else
        return FALSE;
}
