...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_SLATEPORT_CITY] = MAPPOPUP_THEME_BRICK,
    ...
    [MAPSEC_LILYCOVE_CITY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_ROUTE_115] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_ROUTE_123] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_ROUTE_127] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_128] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_129] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_130] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_131] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_132] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_MT_CHIMNEY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_MT_PYRE] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_DESERT_RUINS] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_ANCIENT_TOMB] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_INSIDE_OF_TRUCK] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SKY_PILLAR] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SECRET_BASE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DYNAMIC] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_AQUA_HIDEOUT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MAGMA_HIDEOUT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MIRAGE_TOWER - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_DESERT_UNDERPASS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
