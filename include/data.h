...
#define NO_ITEM_DYNAMIC_LEVEL(party) { .NoItemDynamicLevel = party }, .partySize = ARRAY_COUNT(party), .partyFlags = F_TRAINER_PARTY_DYNAMIC_LEVEL
...
union TrainerMonPtr
{
    ...
    const struct TrainerMonDynamicLevel *NoItemDynamicLevel;
};
