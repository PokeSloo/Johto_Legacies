...
#define VAR_DARKOAL_SURGE_POT_1              0x40DB // 1-15 sets which surge puzzle pot is first
#define VAR_DARKOAL_SURGE_POT_2              0x40DC // Sets which surge puzzle pot is second
...
#define VAR_LAZULAN_STATE                    0x40FF // 1 = Got mega stone
