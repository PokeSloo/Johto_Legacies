...
#define VAR_ECRUTEAK_STATE                   0x40FA // 1 = Defeated Thorne, 2 = Got Strength, 3 = Got 6th badge, 4 = Oliver meet outside Cianwood gym, 5 = Shane outside Resort, 6 = Past resort guards, 7 = Defeated Ariana
