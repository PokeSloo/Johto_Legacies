...
// Johto Megas
#define SPECIES_TYPHLOSION_MEGA              FORMS_START + 329
#define SPECIES_MEGANIUM_MEGA                FORMS_START + 330
#define SPECIES_FERALIGATR_MEGA              FORMS_START + 331
#define SPECIES_HISUIAN_TYPHLOSION_MEGA      FORMS_START + 332

#if P_NEW_POKEMON == TRUE
#define FORMS_START SPECIES_ENAMORUS
#define SPECIES_EGG SPECIES_HISUIAN_TYPHLOSION_MEGA + 1
#else
