...
#define FLAG_GOT_RT30_EGG    0x2A // Get Togepi egg
...
#define FLAG_ALICIA_BOTTOM_ARMOR    0x40 // Azalea gym
#define FLAG_ALICIA_PIANO    0x41 // Azalea gym
#define FLAG_ALICIA_TABLE    0x42 // Azalea gym
#define FLAG_HIDE_AZALEA_GYM_TRAINER_1    0x43 // Azalea gym
#define FLAG_HIDE_AZALEA_GYM_TRAINER_2    0x44 // Azalea gym
#define FLAG_HIDE_AZALEA_GYM_TRAINER_3    0x45 // Azalea gym
#define FLAG_HIDE_AZALEA_GYM_TRAINER_4    0x46 // Azalea gym
...
#define FLAG_ROUTE130_TRADE_STONE            0x68
...
#define FLAG_MOVE_TUTOR_TAUGHT_METRONOME     0x1B5 // Unused now
#define FLAG_MOVE_TUTOR_TAUGHT_SLEEP_TALK    0x1B6 // Unused now
#define FLAG_MOVE_TUTOR_TAUGHT_SUBSTITUTE    0x1B7 // Unused now
#define FLAG_MOVE_TUTOR_TAUGHT_DYNAMICPUNCH  0x1B8 // Unused now
#define FLAG_MOVE_TUTOR_TAUGHT_DOUBLE_EDGE   0x1B9 // Unused now
#define FLAG_MOVE_TUTOR_TAUGHT_EXPLOSION     0x1BA // Unused now
...
#define FLAG_HIDDEN_ITEM_ROUTE_119_CALCIUM                   (FLAG_HIDDEN_ITEMS_START + 0x05) // Unused now
#define FLAG_HIDDEN_ITEM_ROUTE_119_ULTRA_BALL                (FLAG_HIDDEN_ITEMS_START + 0x06) // Unused now
...
#define FLAG_HIDDEN_ITEM_ROUTE_110_POKE_BALL                 (FLAG_HIDDEN_ITEMS_START + 0x41) // Used for trade stone, ice path 1f
...
#define FLAG_HIDDEN_ITEM_ROUTE_119_FULL_HEAL                 (FLAG_HIDDEN_ITEMS_START + 0x44) // Unused now
#define FLAG_HIDDEN_ITEM_ROUTE_120_RARE_CANDY_2              (FLAG_HIDDEN_ITEMS_START + 0x45)
#define FLAG_HIDDEN_ITEM_ROUTE_120_ZINC                      (FLAG_HIDDEN_ITEMS_START + 0x46) // Unused now
...
#define FLAG_HIDDEN_ITEM_ROUTE_120_REVIVE                    (FLAG_HIDDEN_ITEMS_START + 0x54) // Unused now
...
#define FLAG_HIDDEN_ITEM_ROUTE_119_MAX_ETHER                 (FLAG_HIDDEN_ITEMS_START + 0x57) // Unused now
...
#define FLAG_HIDE_VERDANTURF_TOWN_WANDAS_HOUSE_WALLY                0x326 //Unused now
#define FLAG_HIDE_RUSTURF_TUNNEL_WANDAS_BOYFRIEND                   0x327 //Unused now
#define FLAG_HIDE_VERDANTURF_TOWN_WANDAS_HOUSE_WANDAS_BOYFRIEND     0x328 //Unused now
#define FLAG_HIDE_VERDANTURF_TOWN_WANDAS_HOUSE_WALLYS_UNCLE         0x329 //Unused now
...
#define FLAG_ITEM_VICTORY_ROAD_NEW_FULL_HEAL                        0x402
...
#define FLAG_ITEM_ICE_PATH_SHELL_BELL                               0x409
...
#define FLAG_ITEM_ABANDONED_SHIP_ROOMS_1F_HARBOR_MAIL               0x447 // Unused now
#define FLAG_ITEM_ABANDONED_SHIP_ROOMS_B1F_ESCAPE_ROPE              0x448
#define FLAG_ITEM_ABANDONED_SHIP_ROOMS_2_B1F_DIVE_BALL              0x449 // Unused now
#define FLAG_ITEM_ABANDONED_SHIP_ROOMS_B1F_TM_13                    0x44A // Unused now
#define FLAG_ITEM_ABANDONED_SHIP_ROOMS_2_1F_REVIVE                  0x44B
#define FLAG_ITEM_ABANDONED_SHIP_CAPTAINS_OFFICE_STORAGE_KEY        0x44C // Unused now
#define FLAG_ITEM_ABANDONED_SHIP_HIDDEN_FLOOR_ROOM_3_WATER_STONE    0x44D // Unused now
#define FLAG_ITEM_ABANDONED_SHIP_HIDDEN_FLOOR_ROOM_1_TM_18          0x44E // Unused now
...
#define FLAG_ITEM_VICTORY_ROAD_PEAT_BLOCK                           0x454
...
#define FLAG_CAUGHT_ROTOM                                           0x46E // Route 27 house
#define FLAG_ITEM_ROUTE_104_POTION                                  0x46F
#define FLAG_ROUTE_45_SOLAR_BEAM                                    0x470
#define FLAG_ITEM_ROUTE_103_PP_UP                                   0x471
#define FLAG_DARK_CAVE_PEAT_BLOCK                                   0x472
...
#define FLAG_ITEM_ROUTE_120_REVIVE                                  0x47C // Unused now
...
#define FLAG_ROUJEM_PHOENIX_STAIRCASE                               0x4DA // Opened hidden staircase in Roujem phoenix base
